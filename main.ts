...
let members: string[] =['Quba', 'Zainab', 'Aliza', 'Aina', 'Muntaha'];
...
let members: string[] =['Quba', 'Zainab', 'Aliza', 'Aina', 'Muntaha'];
let message: string= " : Wishing a blessed and cheerful Ramadan to you!";
for(let i=0; i<members.length; i++){
...
let transportation: string[] = ['Civic', 'Bike', 'Corolla', 'AUDI', 'Mercedes'];
...
let guest_list: string[] = ['Asfahan', 'Shiza', 'Wasay', 'Saniya'];
...
let not_present: string = 'Asfahan';
let new_guest: string = 'Soha';
...
let guest_list: string[] = ['Asfahan', 'Shiza', 'Wasay', 'Saniya', 'Azlan'];
// for(let i=0; i<guest_list.length; i++){
//     console.log('Dear!' + guest_list[i] + ',\nI invited you on dinner tomorrow.\n\nThank You!\n');
// }
...
let programmingLanguages: string[] = ["Javascript","Python","Typescript","HTML","PHP","CSS"];
...
// Assignment no 21  (They think of something):
interface ITCourse {
    courseName: string;
    location: string;
...
// creating a Array
let petAnimals: string[] = ["Cat", "Dog", "Rabbit", "Parrot"]
...
function make_album(artsit_name: string, album_title: string, tracks?: number ){
